...
AC_CACHE_VAL(ac_cv_xmhtml_includes,
[
ac_xmhtml_save_LIBS="$LIBS"
ac_xmhtml_save_CFLAGS="$CFLAGS"
ac_xmhtml_save_CPPFLAGS="$CPPFLAGS"
ac_xmhtml_save_LDFLAGS="$LDFLAGS"
#
...
if test -f "$dir/XmHTML/XmHTML.h"; then
	ac_cv_xmhtml_includes="$dir"
	break
fi
done
])
#
LIBS="$ac_xmhtml_save_LIBS"
CFLAGS="$ac_xmhtml_save_CFLAGS"
CPPFLAGS="$ac_xmhtml_save_CPPFLAGS"
LDFLAGS="$ac_xmhtml_save_LDFLAGS"
])
xmhtml_includes="$ac_cv_xmhtml_includes"
fi
#
#
...
AC_CACHE_VAL(ac_cv_xmhtml_libraries,
[
ac_xmhtml_save_LIBS="$LIBS"
ac_xmhtml_save_CFLAGS="$CFLAGS"
ac_xmhtml_save_CPPFLAGS="$CPPFLAGS"
...
#
xmhtml_libraries="$ac_cv_xmhtml_libraries"
fi
#
