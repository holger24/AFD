...
#ifndef __mafd_ctrl_h
#define __mafd_ctrl_h
...
struct afd_control_perm
       {
          ...
          signed char simulation;            /* Enable/disable simulation*/
          signed char retry;                 /* Retry sending file       */
          signed char show_slog;             /* Show System Log          */
          signed char show_mlog;             /* Show Maintainer Log      */
...
extern void        calc_but_coord(int),
                   ...
                   open_close_all_groups(Widget, XtPointer, XtPointer),
