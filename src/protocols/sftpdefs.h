...
#define DEFAULT_SFTP_TRANSFER_BLOCKSIZE MIN_SFTP_BLOCKSIZE
#define MAX_SFTP_BLOCKSIZE              262144    /* 256 KBytes */
#define MAX_SFTP_WRITE_BLOCKSIZE        MAX_SFTP_BLOCKSIZE
#define MAX_SFTP_READ_BLOCKSIZE         65536     /*  64 KBytes */
