/*
 *  delete_wrapper_sftp.c - Part of AFD, an automatic file distribution program.
...
/*
 ** NAME
 **   delete_wrapper_sftp - wrapper function for SFTP delete operation
 **
 ** SYNOPSIS
